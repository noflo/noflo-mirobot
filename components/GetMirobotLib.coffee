...
class GetMirobotLib extends noflo.Component
  description: 'Mirobot.js library'
  icon: 'pencil'
  ...
  constructor: ->
    ...
    @inPorts.bang.on 'data', (data) =>
        @outPorts.lib.send library.Mirobot

exports.getComponent = -> new GetMirobotLib
